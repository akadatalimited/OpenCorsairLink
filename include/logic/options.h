...
struct option_flags {
  ...
  unsigned int show_status : 1;
  unsigned int show_json : 1;
};
...
static struct option long_options[] = {
    ...
    {"status", no_argument, 0, OPTION_STATUS},
...
#define INIT_RAINBOW_LED(xx) \
  xx[0].red = 0xff; xx[0].green = 0x00; xx[0].blue = 0x00; \
  xx[1].red = 0xff; xx[1].green = 0x80; xx[1].blue = 0x00; \
  xx[2].red = 0xff; xx[2].green = 0xff; xx[2].blue = 0x00; \
  xx[3].red = 0x00; xx[3].green = 0xff; xx[3].blue = 0x00; \
  xx[4].red = 0x00; xx[4].green = 0x00; xx[4].blue = 0xff; \
  xx[5].red = 0x4b; xx[5].green = 0x00; xx[5].blue = 0x82; \
  xx[6].red = 0x7f; xx[6].green = 0x00; xx[6].blue = 0xff;
